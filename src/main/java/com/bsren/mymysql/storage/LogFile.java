...
import com.bsren.mymysql.common.Debug;
...
//                            if(tid.getId()==txid && !set.contains(pageId)){
//                                set.add(pageId);
...
//                                Page temp = null;
//                                for (Page page : l1) {
//                                    if(page.getId().equals(before.getId())){
//                                        temp=page;
//                                        break;
//                                    }
//                                }
...
//                                for(Page page:l2){
//                                    if(page.getId().equals(after.getId())){
//                                        temp=page;
//                                        break;
//                                    }
//                                }
...
//                        pages = beforePages.get(txid);
//                    }else{
//                        pages = afterPages.get(txid);
//                    }
//                    for (Page page : pages) {
